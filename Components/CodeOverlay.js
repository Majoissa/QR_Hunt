...
function CodeOverlay({ onEditPress, code, onCodeChange, colors }) {
  ...
  const togglePanel = (button) => {
    ...
    if (button === "qr") setQrIcon(SelectedQR);
    else setQrIcon(QRIcon);
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonGroup}>
        <TouchableOpacity
          style={
            selectedButton === "qr" ? styles.selectedButton : styles.qrButton
          }
          onPress={() => (getInputCode ? null : togglePanel("qr"))}
        >
        ...
        <TouchableOpacity
          ...
          onPress={() => (getInputCode ? null : togglePanel("code"))}
        >
          <Text
            style={
              selectedButton === "code"
                ? styles.codeSelectedText
                : styles.codeText
            }
          >
            432
